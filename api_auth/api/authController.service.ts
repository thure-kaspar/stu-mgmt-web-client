...
export class AuthControllerService {
    ...
    public authenticate(body: CredentialsDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<AuthenticationInfoDto>('post',`${this.basePath}/api/v0/authenticate`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public isTokenValid(observe?: 'body', reportProgress?: boolean): Observable<AuthenticationInfoDto>;
    public isTokenValid(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AuthenticationInfoDto>>;
    public isTokenValid(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AuthenticationInfoDto>>;
    public isTokenValid(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<AuthenticationInfoDto>('get',`${this.basePath}/api/v0/authenticate/check`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
