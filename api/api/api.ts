...
export const APIS = [AdmissionStatusService, AssessmentService, AssessmentAllocationService, AssignmentService, AssignmentRegistrationService, AuthenticationService, CourseService, CourseConfigService, CourseParticipantsService, CsvService, DefaultService, GroupService, NotificationService, SubmissionService, UserService];
