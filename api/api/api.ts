...
export const APIS = [AssessmentAllocationService, AssessmentsService, AssignmentsService, AuthenticationService, CourseConfigService, CourseParticipantsService, CoursesService, DefaultService, GroupsService, MailService, TestService, UsersService];
