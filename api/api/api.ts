...
export const APIS = [AdmissionStatusService, AssessmentAllocationService, AssessmentsService, AssignmentRegistrationService, AssignmentsService, AuthenticationService, CourseConfigService, CourseParticipantsService, CoursesService, CsvService, DefaultService, ExportService, GroupsService, MailService, SubmissionService, TaskSchedulerService, TestService, UsersService];
