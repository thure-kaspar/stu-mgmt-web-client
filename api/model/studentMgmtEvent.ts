...
export namespace StudentMgmtEvent {
    export type EventEnum = 'COURSE_JOINED' | 'ASSIGNMENT_CREATED' | 'ASSIGNMENT_REMOVED' | 'ASSIGNMENT_STATE_CHANGED' | 'GROUP_REGISTERED' | 'GROUP_UNREGISTERED' | 'USER_REGISTERED' | 'USER_UNREGISTERED' | 'USER_JOINED_GROUP' | 'USER_LEFT_GROUP';
